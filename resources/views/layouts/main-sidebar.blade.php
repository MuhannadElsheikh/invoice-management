...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            @can('المستخدمين') <li class="side-item side-item-category">المستحدمين</li>    @endcan
            <li class="slide">
                @can('المستخدمين')
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                            xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                        ...
                        <span class="side-menu__label">المستحدمين</span><i class="angle fe fe-chevron-down"></i></a>
                @endcan
                <ul class="slide-menu">
                    ...
                    @can('صلاحيات المستخدمين ')
                        <li><a class="slide-item" href="{{ url('/' . ($page = 'roles')) }}">صلاحيات المتخدمين</a></li>
                    @endcan
                </ul>
            </li>
            ...
            @can('الاعدادات ')   <li class="side-item side-item-category">الاعدادات</li>     @endcan
            <li class="slide">
                @can('الاعدادات ')
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
