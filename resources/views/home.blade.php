                        ...
                        <div class="d-flex">
                            ...
                            <span class="float-right my-auto mr-auto">
                                <span class="text-white op-7">
                                    {{App\models\Invoices::count() > 0 ? round((App\models\Invoices::where('value_status', 2)->count() / App\models\Invoices::count()) * 100): 0 }}%</span>
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            ...
                            <span class="float-right my-auto mr-auto">
                                <span class="text-white op-7">
                                    {{ App\models\Invoices::count() > 0 ? round((App\models\Invoices::where('value_status', 1)->count() / App\models\Invoices::count()) * 100, 0) : 0 }}%
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            ...
                            <span class="float-right my-auto mr-auto">
                                ...
                                <span class="text-white op-7">
                                    {{ App\models\Invoices::count() > 0 ? round((App\models\Invoices::where('value_status', 3)->count() / App\models\Invoices::count()) * 100, 0) : 0 }}%
